package com.modo.apps.dictee;

import com.modo.apps.dictee.config.ApplicationProperties;
import com.modo.apps.dictee.config.DefaultProfileUtil;
...
public class JBaptisteApp {
    ...
    public JBaptisteApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes JBaptiste.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JBaptisteApp.class);
